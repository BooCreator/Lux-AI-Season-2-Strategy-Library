...
class Eyes:
    ...
    # ------- Примеры аргументов: names['field1', np.array([[0,1],[1,1]]), Eyes.norm('field2')] -----------------
    # = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
    def mul(self, names:list) -> np.ndarray:
        ''' Сумировать матрицы '''
        result = np.ones(self.map_size, dtype=int)
        for name in names:
            if type(name) is str:
                if name in self.data.keys():
                    result = result * self.data.get(name)
    ...
    # ------- Примеры аргументов: names['field1', np.array([[0,1],[1,1]]), Eyes.norm('field2')] -----------------
    # = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
    def div(self, names:list) -> np.ndarray:
        ''' Сумировать матрицы '''
        result = None
        for name in names:
            if type(name) is str:
        ...
        if type(name) is str:
            ...
            for table in name:
                if type(table) is str:
                    ...
                    tid += 1
    # = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
    # ----- Проверть наличие значения в матрице по позиции ------------------------------------------------------
    # ------- name - матрица ------------------------------------------------------------------------------------
    # ------- index - индекс ------------------------------------------------------------------------------------
    # ------- value - искомое значение --------------------------------------------------------------------------
    # = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
    def has(self, name:str, index:np.ndarray, value:int=1) -> bool:
        if type(name) is str:
            if name in self.data.keys():
            ...
            for key in name:
                if not self.has(key, index, value):
                    break
            return True
        if table is not None:
            if table.shape[0] >= index[0] and table.shape[1] >= index[1]:
                return table[index[0], index[1]] == value
        return False
    # = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
    # ----- Объединить данных двух классов ----------------------------------------------------------------------
    # = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
    def extend(self, eyes, rw:bool=True):
        for key, value in eyes.data.items():
            if rw or key not in self.data.keys():
                self.data[key] = value
            else:
                raise Exception(f'{key} exists in keys')
        return self
    # = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
    # ----- Костыль для RL --------------------------------------------------------------------------------------
    # = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
