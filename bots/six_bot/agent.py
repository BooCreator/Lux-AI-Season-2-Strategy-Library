...
from strategy.game.robot.curious import RobotStrategy
from strategy.game.factory.mean_water import FactoryStrategy
...
class Agent():
    ...
    def __init__(self, player: str, env_cfg: EnvConfig, *, strategy: Strategy=None, early=None, game=None) -> None:
        ...
        self.strategy = Strategy(env_cfg, early, game=GameStrategy(env_cfg, robotStrategy=RobotStrategy, factoryStrategy=FactoryStrategy)) if strategy is None else (strategy(env_cfg, early, game) if type(strategy) is type else strategy)
    # = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
