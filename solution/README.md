...
* *default* - Базовая стратегия библиотеки расстановки фабрик. Позиция для фабрики выбирается случайно на основе ранее составленной матрицы весов. Подробный алгоритм составления матрицы весов описан [здесь](https://github.com/BooCreator/Lux-AI-Season-2-Strategy-Library/blob/main/solution/early_weightning.md).
...
Более подробный алгоритм поиска пути описан [здесь](https://github.com/BooCreator/Lux-AI-Season-2-Strategy-Library/blob/main/solution/pathfinding.md)
